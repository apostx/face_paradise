	...
	function render() '
		<div>
			<div class="fp_room_list_title">
				<div class="fp_title">Choose a game room</div>
			...
			<div class="fp_button fp_button--create_room" onclick=$createRoomRequest><i class="fas fa-plus-circle fp_left_icon"></i>Create Room</div>
		</div>
	';
}